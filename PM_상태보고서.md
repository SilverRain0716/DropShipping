...
| Phase | 채널 | 상태 | 진입 조건 |
|---|---|---|---|
| 1-A | **Etsy US** | 🟢 신원인증 완료 / 리스팅 대기 | 위닝 상품 확정 즉시 |
...
| 신원인증 | ✅ Persona Express Biometric 완료 (2026-03-08) |
| 리스팅 초안 | ✅ #1 #2 완료 |
| 라이브 상태 | 🟢 리스팅 업로드 대기 (위닝 상품 확정 후 즉시 가능) |
...
## 📅 Day 6 우선순위
1. 🔴 Etsy 위닝 상품 확정 즉시 첫 리스팅 업로드 (신원인증 ✅ 완료)
